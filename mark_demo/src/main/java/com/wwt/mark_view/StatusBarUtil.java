...
public class StatusBarUtil {
     ...
     * 为布局文件中新增的状态栏布局设置背景色和高度
     */
    public static void setStatusViewAttrColor(View view, Activity activity,@ColorRes int color) {
        if (view == null || activity == null) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
    ...
    public static void setNavigationBarColor(Activity context,@ColorRes int color){
...
//                window.setNavigationBarColor(Color.BLACK);
                ...
                window.setNavigationBarColor(context.getResources().getColor(color));
            }
        }
    }
